...
Config_eventdisplay::Config_eventdisplay(){
  nevents = Getint("NEVENTS");
  infile = Getchar("INFILE");
  ...
  trueposition = TVector3(truex,truey,truez);
  ogfuncname = Getchar("OGFUNCNAME");
}
...
Config_eventdisplay_image::Config_eventdisplay_image(){
  infile = Getchar("INFILE");
  inhist = Getchar("INHIST");
  infile_geom = Getchar("INFILEGEOM");
  outfile = Getchar("OUTFILE");
}
