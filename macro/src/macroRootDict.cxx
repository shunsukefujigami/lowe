//
// File generated by /home/fujigami/retro/root_build/bin/rootcint at Fri Dec 18 13:32:55 2020
...
namespace ROOTDict {
   ...
   static ROOT::TGenericClassInfo *GenerateInitInstanceLocal(const ::OneRunAnalizeManager*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("OneRunAnalizeManager", ::OneRunAnalizeManager::Class_Version(), "/home/fujigami/retro/lowe/source/macro/include/OneRunAnalizeManager.hh", 22,
...
void OneRunAnalizeManager::ShowMembers(TMemberInspector &R__insp)
{
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "*ldata", &ldata);
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "*costhetahist", &costhetahist);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "*phihist", &phihist);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "*deltaanglehist", &deltaanglehist);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "*fgaussiancostheta", &fgaussiancostheta);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "*fgaussianphi", &fgaussianphi);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "*hittime", &hittime);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "*tofnoretro", &tofnoretro);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "*tofonretro", &tofonretro);
...
void MultiRunAnalizeManager::ShowMembers(TMemberInspector &R__insp)
{
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "*anglemean", &anglemean);
      TClonesArray::ShowMembers(R__insp);
}
...
static int G__macroRootDict_328_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   ...
   if ((gvp == (char*)G__PVOID) || (gvp == 0)) {
     p = new MultiRunAnalizeManager(
(FileList*) G__int(libp->para[0]), (FileList*) G__int(libp->para[1])
, (FileList*) G__int(libp->para[2]), (int) G__int(libp->para[3]));
   } else {
     p = new((void*) gvp) MultiRunAnalizeManager(
(FileList*) G__int(libp->para[0]), (FileList*) G__int(libp->para[1])
, (FileList*) G__int(libp->para[2]), (int) G__int(libp->para[3]));
...
{
      ((MultiRunAnalizeManager*) G__getstructoffset())->Setdatafile((FileList*) G__int(libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((MultiRunAnalizeManager*) G__getstructoffset())->Setlikelihoodfile((FileList*) G__int(libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((MultiRunAnalizeManager*) G__getstructoffset())->fitanglemean((double) G__double(libp->para[0]), (double) G__double(libp->para[1])
, (double) G__double(libp->para[2]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__macroRootDict_328_0_19(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) ((MultiRunAnalizeManager*) G__getstructoffset())->Getanglemean());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__macroRootDict_328_0_20(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) MultiRunAnalizeManager::Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__macroRootDict_328_0_21(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__macroRootDict_328_0_28(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) MultiRunAnalizeManager::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__macroRootDict_328_0_29(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) MultiRunAnalizeManager::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__macroRootDict_328_0_30(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) MultiRunAnalizeManager::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__macroRootDict_328_0_31(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__macroRootDict_328_0_32(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
   long soff = G__getstructoffset();
   int n = G__getaryconstruct();
...
static int G__macroRootDict_384_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__macroRootDict_385_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   ...
   case 4:
     ...
     if ((gvp == (char*)G__PVOID) || (gvp == 0)) {
       p = new OneRunAnalizeManager(
(TFile*) G__int(libp->para[0]), (TFile*) G__int(libp->para[1])
, (TFile*) G__int(libp->para[2]), (int) G__int(libp->para[3]));
     } else {
       p = new((void*) gvp) OneRunAnalizeManager(
(TFile*) G__int(libp->para[0]), (TFile*) G__int(libp->para[1])
, (TFile*) G__int(libp->para[2]), (int) G__int(libp->para[3]));
...
{
      ((OneRunAnalizeManager*) G__getstructoffset())->Setdatafile((TFile*) G__int(libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
static int G__macroRootDict_385_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 2:
      ((OneRunAnalizeManager*) G__getstructoffset())->SetLikelihoodfile((TFile*) G__int(libp->para[0]), (int) G__int(libp->para[1]));
      G__setnull(result7);
      break;
   case 1:
      ((OneRunAnalizeManager*) G__getstructoffset())->SetLikelihoodfile((TFile*) G__int(libp->para[0]));
      G__setnull(result7);
      break;
   }
   return(1 || funcname || hash || result7 || libp) ;
...
{
      G__letint(result7, 85, (long) ((OneRunAnalizeManager*) G__getstructoffset())->GetCosThetaHist());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__macroRootDict_385_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) ((OneRunAnalizeManager*) G__getstructoffset())->GetPhiHist());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__macroRootDict_385_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) ((OneRunAnalizeManager*) G__getstructoffset())->GetDeltaAngleHist());
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((OneRunAnalizeManager*) G__getstructoffset())->FillHitTime((int) G__int(libp->para[0]), (double) G__double(libp->para[1])
, (double) G__double(libp->para[2]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      G__letint(result7, 85, (long) ((OneRunAnalizeManager*) G__getstructoffset())->GetHitTime());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__macroRootDict_385_0_23(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((OneRunAnalizeManager*) G__getstructoffset())->Filltofnoretro((int) G__int(libp->para[0]), (double) G__double(libp->para[1])
, (double) G__double(libp->para[2]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      G__letint(result7, 85, (long) ((OneRunAnalizeManager*) G__getstructoffset())->Gettofnoretro());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__macroRootDict_385_0_25(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((OneRunAnalizeManager*) G__getstructoffset())->Filltofonretro((int) G__int(libp->para[0]), (double) G__double(libp->para[1])
, (double) G__double(libp->para[2]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      G__letint(result7, 85, (long) ((OneRunAnalizeManager*) G__getstructoffset())->Gettofonretro());
   return(1 || funcname || hash || result7 || libp) ;
}
...
static int G__macroRootDict_385_0_35(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__macroRootDict_385_0_39(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__macroRootDict_385_0_40(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) OneRunAnalizeManager::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__macroRootDict_385_0_41(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) OneRunAnalizeManager::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__macroRootDict_385_0_42(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) OneRunAnalizeManager::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__macroRootDict_385_0_43(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
// automatic copy constructor
static int G__macroRootDict_385_0_44(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G__macroRootDict_385_0_45(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
   long soff = G__getstructoffset();
   int n = G__getaryconstruct();
...
// automatic assignment operator
static int G__macroRootDict_385_0_46(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static void G__setup_memvarMultiRunAnalizeManager(void) {
   ...
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__macroRootDictLN_TH1D),-1,-1,4,"anglemean=",0,(char*)NULL);
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__macroRootDictLN_TClass),G__defined_typename("atomic_TClass_ptr"),-2,4,"fgIsA=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}
...
static void G__setup_memvarOneRunAnalizeManager(void) {
   ...
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__macroRootDictLN_l_dir_data),-1,-1,4,"ldata=",0,(char*)NULL);
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__macroRootDictLN_AngleRange),-1,-1,4,"arange=",0,(char*)NULL);
   ...
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__macroRootDictLN_TH1D),-1,-1,4,"costhetahist=",0,(char*)NULL);
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__macroRootDictLN_TH1D),-1,-1,4,"phihist=",0,(char*)NULL);
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__macroRootDictLN_TH1D),-1,-1,4,"deltaanglehist=",0,(char*)NULL);
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__macroRootDictLN_TF1),-1,-1,4,"fgaussiancostheta=",0,(char*)NULL);
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__macroRootDictLN_TF1),-1,-1,4,"fgaussianphi=",0,(char*)NULL);
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__macroRootDictLN_TH1D),-1,-1,4,"hittime=",0,(char*)NULL);
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__macroRootDictLN_TH1D),-1,-1,4,"tofnoretro=",0,(char*)NULL);
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__macroRootDictLN_TH1D),-1,-1,4,"tofonretro=",0,(char*)NULL);
...
"U 'FileList' - 0 - datafilelist i - - 0 - NRun_in", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("MultiRunAnalizeManager",2239,G__macroRootDict_328_0_4, 105, G__get_linked_tagnum(&G__macroRootDictLN_MultiRunAnalizeManager), -1, 0, 4, 1, 1, 0, 
"U 'FileList' - 0 - datafilelist U 'FileList' - 0 - goodnessfilelist "
"U 'FileList' - 0 - likelihoodfilellist i - - 0 - NRun_in", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Setdatafile",1126,G__macroRootDict_328_0_5, 121, -1, -1, 0, 1, 1, 1, 0, "U 'FileList' - 0 - datafilelist", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetGoodnessfile",1550,G__macroRootDict_328_0_6, 121, -1, -1, 0, 1, 1, 1, 0, "U 'FileList' - 0 - goodnessfilelist", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Setlikelihoodfile",1776,G__macroRootDict_328_0_7, 121, -1, -1, 0, 1, 1, 1, 0, "U 'FileList' - 0 - likelihoodfilelist", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetNRun",675,G__macroRootDict_328_0_8, 105, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Fillefficiency",1436,G__macroRootDict_328_0_9, 121, -1, -1, 0, 3, 1, 1, 0, 
"d - - 0 - xmin d - - 0 - xmax "
"d - - 0 - xwidth", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Getefficiency",1333,G__macroRootDict_328_0_10, 85, G__get_linked_tagnum(&G__macroRootDictLN_TH1D), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Fillerrorandbiasgaussian",2526,G__macroRootDict_328_0_11, 121, -1, -1, 0, 3, 1, 1, 0, 
"d - - 0 - xmin d - - 0 - xmax "
"d - - 0 - xwidth", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Getxerror",962,G__macroRootDict_328_0_12, 85, G__get_linked_tagnum(&G__macroRootDictLN_TH1D), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Getyerror",963,G__macroRootDict_328_0_13, 85, G__get_linked_tagnum(&G__macroRootDictLN_TH1D), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Getzerror",964,G__macroRootDict_328_0_14, 85, G__get_linked_tagnum(&G__macroRootDictLN_TH1D), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Getxbias",823,G__macroRootDict_328_0_15, 85, G__get_linked_tagnum(&G__macroRootDictLN_TH1D), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Getybias",824,G__macroRootDict_328_0_16, 85, G__get_linked_tagnum(&G__macroRootDictLN_TH1D), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Getzbias",825,G__macroRootDict_328_0_17, 85, G__get_linked_tagnum(&G__macroRootDictLN_TH1D), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("fitanglemean",1259,G__macroRootDict_328_0_18, 121, -1, -1, 0, 3, 1, 1, 0, 
"d - - 0 - xmin d - - 0 - xmax "
"d - - 0 - xwidth", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Getanglemean",1224,G__macroRootDict_328_0_19, 85, G__get_linked_tagnum(&G__macroRootDictLN_TH1D), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__macroRootDict_328_0_20, 85, G__get_linked_tagnum(&G__macroRootDictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&MultiRunAnalizeManager::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__macroRootDict_328_0_21, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&MultiRunAnalizeManager::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__macroRootDict_328_0_22, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&MultiRunAnalizeManager::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__macroRootDict_328_0_23, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&MultiRunAnalizeManager::Dictionary) ), 0);
   G__memfunc_setup("IsA",253,(G__InterfaceMethod) NULL,85, G__get_linked_tagnum(&G__macroRootDictLN_TClass), -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("ShowMembers",1132,(G__InterfaceMethod) NULL,121, -1, -1, 0, 1, 1, 1, 0, "u 'TMemberInspector' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Streamer",835,(G__InterfaceMethod) NULL,121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("StreamerNVirtual",1656,G__macroRootDict_328_0_27, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__macroRootDict_328_0_28, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&MultiRunAnalizeManager::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__macroRootDict_328_0_29, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&MultiRunAnalizeManager::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__macroRootDict_328_0_30, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&MultiRunAnalizeManager::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__macroRootDict_328_0_31, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&MultiRunAnalizeManager::DeclFileLine) ), 0);
   // automatic destructor
   G__memfunc_setup("~MultiRunAnalizeManager", 2365, G__macroRootDict_328_0_32, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   G__tag_memfunc_reset();
}
...
static void G__setup_memfuncAngleRange(void) {
   ...
   G__memfunc_setup("AngleRange",980,G__macroRootDict_384_0_1, 105, G__get_linked_tagnum(&G__macroRootDictLN_AngleRange), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Setrange",825,G__macroRootDict_384_0_2, 121, -1, -1, 0, 1, 1, 1, 0, "u 'AngleRange' - 0 - range", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetCosthetamin",1439,G__macroRootDict_384_0_3, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetCosthetamin",1451,G__macroRootDict_384_0_4, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 0 - costheta", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetCosthetawidth",1659,G__macroRootDict_384_0_5, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetCosthetawidth",1671,G__macroRootDict_384_0_6, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 0 - width", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetCosthetaNum",1419,G__macroRootDict_384_0_7, 105, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetCosthetaNum",1431,G__macroRootDict_384_0_8, 121, -1, -1, 0, 1, 1, 1, 0, "i - - 0 - num", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetPhimin",901,G__macroRootDict_384_0_9, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetPhimin",913,G__macroRootDict_384_0_10, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 0 - min", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetPhiwidth",1121,G__macroRootDict_384_0_11, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetPhiwidth",1133,G__macroRootDict_384_0_12, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 0 - width", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetPhiNum",881,G__macroRootDict_384_0_13, 105, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetPhiNum",893,G__macroRootDict_384_0_14, 121, -1, -1, 0, 1, 1, 1, 0, "i - - 0 - num", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetCosthetamax",1441,G__macroRootDict_384_0_15, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetPhimax",903,G__macroRootDict_384_0_16, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__macroRootDict_384_0_17, 85, G__get_linked_tagnum(&G__macroRootDictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&AngleRange::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__macroRootDict_384_0_18, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&AngleRange::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__macroRootDict_384_0_19, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&AngleRange::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__macroRootDict_384_0_20, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&AngleRange::Dictionary) ), 0);
   G__memfunc_setup("IsA",253,(G__InterfaceMethod) NULL,85, G__get_linked_tagnum(&G__macroRootDictLN_TClass), -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("ShowMembers",1132,(G__InterfaceMethod) NULL,121, -1, -1, 0, 1, 1, 1, 0, "u 'TMemberInspector' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Streamer",835,(G__InterfaceMethod) NULL,121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("StreamerNVirtual",1656,G__macroRootDict_384_0_24, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__macroRootDict_384_0_25, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&AngleRange::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__macroRootDict_384_0_26, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&AngleRange::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__macroRootDict_384_0_27, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&AngleRange::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__macroRootDict_384_0_28, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&AngleRange::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("AngleRange", 980, G__macroRootDict_384_0_29, (int) ('i'), G__get_linked_tagnum(&G__macroRootDictLN_AngleRange), -1, 0, 1, 1, 1, 0, "u 'AngleRange' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~AngleRange", 1106, G__macroRootDict_384_0_30, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__macroRootDict_384_0_31, (int) ('u'), G__get_linked_tagnum(&G__macroRootDictLN_AngleRange), -1, 1, 1, 1, 1, 0, "u 'AngleRange' - 11 - -", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
...
static void G__setup_memfuncOneRunAnalizeManager(void) {
   ...
   G__memfunc_setup("OneRunAnalizeManager",2006,G__macroRootDict_385_0_1, 105, G__get_linked_tagnum(&G__macroRootDictLN_OneRunAnalizeManager), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("OneRunAnalizeManager",2006,G__macroRootDict_385_0_2, 105, G__get_linked_tagnum(&G__macroRootDictLN_OneRunAnalizeManager), -1, 0, 1, 1, 1, 0, "U 'TFile' - 0 - datafile", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("OneRunAnalizeManager",2006,G__macroRootDict_385_0_3, 105, G__get_linked_tagnum(&G__macroRootDictLN_OneRunAnalizeManager), -1, 0, 3, 1, 1, 0, 
"U 'TFile' - 0 - datafile U 'TFile' - 0 - goodnessfile "
"i - - 0 '0' filenumber", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("OneRunAnalizeManager",2006,G__macroRootDict_385_0_4, 105, G__get_linked_tagnum(&G__macroRootDictLN_OneRunAnalizeManager), -1, 0, 4, 1, 1, 0, 
"U 'TFile' - 0 - datafile U 'TFile' - 0 - goodnessfile "
"U 'TFile' - 0 - likelihoodfile i - - 0 '0' filenumber", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Setdatafile",1126,G__macroRootDict_385_0_5, 121, -1, -1, 0, 1, 1, 1, 0, "U 'TFile' - 0 - datafile", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetGoodnessfile",1550,G__macroRootDict_385_0_6, 121, -1, -1, 0, 2, 1, 1, 0, 
"U 'TFile' - 0 - goodnessfile i - - 0 '0' filenumber", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetLikelihoodfile",1744,G__macroRootDict_385_0_7, 121, -1, -1, 0, 2, 1, 1, 0, 
"U 'TFile' - 0 - likelihoodfile i - - 0 '0' filenumber", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetXHist",784,G__macroRootDict_385_0_8, 85, G__get_linked_tagnum(&G__macroRootDictLN_TH1D), -1, 0, 2, 1, 1, 0, 
"C - - 10 '\"\"' name C - - 10 '\"\"' title", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetYHist",785,G__macroRootDict_385_0_9, 85, G__get_linked_tagnum(&G__macroRootDictLN_TH1D), -1, 0, 2, 1, 1, 0, 
"C - - 10 '\"\"' name C - - 10 '\"\"' title", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetZHist",786,G__macroRootDict_385_0_10, 85, G__get_linked_tagnum(&G__macroRootDictLN_TH1D), -1, 0, 2, 1, 1, 0, 
"C - - 10 '\"\"' name C - - 10 '\"\"' title", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetTHist",780,G__macroRootDict_385_0_11, 85, G__get_linked_tagnum(&G__macroRootDictLN_TH1D), -1, 0, 2, 1, 1, 0, 
"C - - 10 '\"\"' name C - - 10 '\"\"' title", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetCosThetaHist",1491,G__macroRootDict_385_0_12, 85, G__get_linked_tagnum(&G__macroRootDictLN_TH1D), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetPhiHist",985,G__macroRootDict_385_0_13, 85, G__get_linked_tagnum(&G__macroRootDictLN_TH1D), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetDeltaAngleHist",1673,G__macroRootDict_385_0_14, 85, G__get_linked_tagnum(&G__macroRootDictLN_TH1D), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("FitByGaussianAll",1586,G__macroRootDict_385_0_15, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Getfgaussianx",1369,G__macroRootDict_385_0_16, 85, G__get_linked_tagnum(&G__macroRootDictLN_TF1), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Getfgaussiany",1370,G__macroRootDict_385_0_17, 85, G__get_linked_tagnum(&G__macroRootDictLN_TF1), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Getfgaussianz",1371,G__macroRootDict_385_0_18, 85, G__get_linked_tagnum(&G__macroRootDictLN_TF1), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetTH2D",562,G__macroRootDict_385_0_19, 85, G__get_linked_tagnum(&G__macroRootDictLN_TH2D), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("FillTH2D",665,G__macroRootDict_385_0_20, 121, -1, -1, 0, 11, 1, 1, 0, 
"C - - 10 - name C - - 10 - title "
"i - - 0 - n i - - 0 - xnum "
"d - - 0 - xmin d - - 0 - xmax "
"i - - 0 - ynum d - - 0 - ymin "
...
"C - - 10 - yvar", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("FillHitTime",1083,G__macroRootDict_385_0_21, 121, -1, -1, 0, 3, 1, 1, 0, 
"i - - 0 - xnum d - - 0 - xmin "
"d - - 0 - xmax", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetHitTime",980,G__macroRootDict_385_0_22, 85, G__get_linked_tagnum(&G__macroRootDictLN_TH1D), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Filltofnoretro",1497,G__macroRootDict_385_0_23, 121, -1, -1, 0, 3, 1, 1, 0, 
"i - - 0 - xnum d - - 0 - xmin "
"d - - 0 - xmax", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Gettofnoretro",1394,G__macroRootDict_385_0_24, 85, G__get_linked_tagnum(&G__macroRootDictLN_TH1D), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Filltofonretro",1497,G__macroRootDict_385_0_25, 121, -1, -1, 0, 3, 1, 1, 0, 
"i - - 0 - xnum d - - 0 - xmin "
"d - - 0 - xmax", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Gettofonretro",1394,G__macroRootDict_385_0_26, 85, G__get_linked_tagnum(&G__macroRootDictLN_TH1D), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetEfficiency",1301,G__macroRootDict_385_0_27, 100, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetWCSimRootEvent",1673,G__macroRootDict_385_0_28, 85, G__get_linked_tagnum(&G__macroRootDictLN_WCSimRootEvent), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetVariable",1094,(G__InterfaceMethod) NULL, 100, -1, -1, 0, 1, 1, 4, 0, "C - - 10 - valname", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Gettofnoretro",1394,(G__InterfaceMethod) NULL, 100, -1, -1, 0, 1, 1, 4, 0, "U 'WCSimRootCherenkovDigiHit' - 0 - hit", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Gettofonretro",1394,(G__InterfaceMethod) NULL, 100, -1, -1, 0, 1, 1, 4, 0, "U 'WCSimRootCherenkovDigiHit' - 0 - hit", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__macroRootDict_385_0_32, 85, G__get_linked_tagnum(&G__macroRootDictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&OneRunAnalizeManager::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__macroRootDict_385_0_33, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&OneRunAnalizeManager::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__macroRootDict_385_0_34, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&OneRunAnalizeManager::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__macroRootDict_385_0_35, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&OneRunAnalizeManager::Dictionary) ), 0);
   G__memfunc_setup("IsA",253,(G__InterfaceMethod) NULL,85, G__get_linked_tagnum(&G__macroRootDictLN_TClass), -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("ShowMembers",1132,(G__InterfaceMethod) NULL,121, -1, -1, 0, 1, 1, 1, 0, "u 'TMemberInspector' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Streamer",835,(G__InterfaceMethod) NULL,121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("StreamerNVirtual",1656,G__macroRootDict_385_0_39, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__macroRootDict_385_0_40, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&OneRunAnalizeManager::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__macroRootDict_385_0_41, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&OneRunAnalizeManager::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__macroRootDict_385_0_42, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&OneRunAnalizeManager::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__macroRootDict_385_0_43, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&OneRunAnalizeManager::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("OneRunAnalizeManager", 2006, G__macroRootDict_385_0_44, (int) ('i'), G__get_linked_tagnum(&G__macroRootDictLN_OneRunAnalizeManager), -1, 0, 1, 1, 1, 0, "u 'OneRunAnalizeManager' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~OneRunAnalizeManager", 2132, G__macroRootDict_385_0_45, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__macroRootDict_385_0_46, (int) ('u'), G__get_linked_tagnum(&G__macroRootDictLN_OneRunAnalizeManager), -1, 1, 1, 1, 1, 0, "u 'OneRunAnalizeManager' - 11 - -", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
