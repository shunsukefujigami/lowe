...
void OneGoodnessCalculateManager::SetParameters()
{
  ...
  WCradius = GoodnessManager::GetGoodnessManager()->GetWCSimRootGeom()->GetWCCylRadius();
  WClength = GoodnessManager::GetGoodnessManager()->GetWCSimRootGeom()->GetWCCylLength();
}
